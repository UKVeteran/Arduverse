 ...
 *                  (____/ 
 * Osoyoo W5100 web server lesson 9
 * Send Obstacle distance to Cell phone APP
 * tutorial url: https://osoyoo.com/?p=32638
 */
...
#define Echo_PIN    7 // Ultrasonic Echo pin connect to D7
#define Trig_PIN    8  // Ultrasonic Trig pin connect to D8
