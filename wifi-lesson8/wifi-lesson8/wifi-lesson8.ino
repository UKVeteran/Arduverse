 ...
 *                  (____/ 
 * Osoyoo W5100 web server lesson 8
 * Send Gas level to Cell phone APP
...
void loop()
{
  ...
  if (packetSize) {
    int sensorValue = analogRead(analogInPin)*100/1024; 


    String msg="Gas Level: "+String(sensorValue)+'\n';
    Serial.print(msg);
    char ReplyBuffer[60];
